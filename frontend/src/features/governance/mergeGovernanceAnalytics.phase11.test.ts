...
import type { GovernanceAnalyticsDetail, GovernanceAnalyticsSummary } from "@/types/governance";
...
const detail: GovernanceAnalyticsDetail = {
  ...
  risk_heatmap: [{ vertical: "Medical", risk_level: "high_risk", project_count: 1, avg_score: 55 }],
};

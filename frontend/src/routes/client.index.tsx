          ...
          <div className="md:col-span-2">
            ...
            <ol className="relative border-l border-border pl-4 text-xs">
              {[
                ...
                <li key={m.m} className="mb-4">
                  <span className="absolute -left-1.5 h-3 w-3 rounded-full bg-[color:var(--brand)]" />
      ...
      <div className="grid grid-cols-1 gap-5 lg:grid-cols-2">
        <Card>
          <SectionHeader
            ...
            sub="Pre-approved status summaries"
            right={<AiBadge confidence={94} />}
          />
          <ul className="space-y-2 text-xs">
            {[
              ...
              <li key={u.t} className="rounded border border-border bg-elevated px-3 py-2">
                <div className="font-medium">{u.t}</div>
                <div className="text-[10px] text-muted-foreground">{u.d}</div>
              </li>
            ))}
          </ul>
        </Card>
        ...
        <Card>
          ...
          <form className="space-y-2">
            <textarea
              rows={4}
              placeholder="Ask about your project, delivery timeline, or quality…"
              className="w-full rounded border border-border bg-elevated px-3 py-2 text-xs outline-none focus:border-[color:var(--brand)]"
            />

...
export const alerts = [
  {
    sev: "Critical",
    project: "Pulse Medical Imaging",
    desc: "IAA dropped below 0.82 threshold across radiology subset",
    ts: "12m ago",
  },
  {
    sev: "Critical",
    project: "Nimbus NLP Curation",
    desc: "Schedule confidence at 61% — 2 dependencies blocking",
    ts: "47m ago",
  },
  {
    sev: "Warning",
    project: "Helios Doc Extraction",
    desc: "Rework rate up 8% week-over-week",
    ts: "1h ago",
  },
  {
    sev: "Warning",
    project: "Falcon Voice Transcription",
    desc: "Two annotators flagged for calibration drift",
    ts: "2h ago",
  },
  {
    sev: "Warning",
    project: "Vertex Finance Docs",
    desc: "Client awaiting response on schema clarification (3d)",
    ts: "3h ago",
  },
];
...
export const recommendations = [
  {
    title: "Re-allocate 4 SMEs from Lumen to Pulse Medical Imaging",
    confidence: 91,
    evidence: 7,
    priority: "High",
  },
  {
    title: "Trigger calibration session for Nimbus NLP team (guideline v3)",
    confidence: 86,
    evidence: 5,
    priority: "High",
  },
  {
    title: "Escalate Helios schema sign-off to client governance call",
    confidence: 78,
    evidence: 4,
    priority: "Medium",
  },
  {
    title: "Shift Orion Region 4 review window by 48h to free QA capacity",
    confidence: 72,
    evidence: 3,
    priority: "Medium",
  },
...
export const milestones = [
  {
    project: "Aurora Vision",
    name: "Batch 14 QA Sign-off",
    due: "Jun 24",
    confidence: 94,
    status: "On Track",
  },
  ...
  {
    project: "Orion Geo",
    name: "Region 4 Delivery",
    due: "Jun 27",
    confidence: 96,
    status: "On Track",
  },
  {
    project: "Pulse Medical",
...
export const activity = [
  {
    ts: "2m ago",
    actor: "Maya Chen",
    text: "Approved AI-drafted weekly summary for Aurora Health",
  },
  {
    ts: "14m ago",
    actor: "Delivery Agent",
    text: "Flagged Pulse Medical Imaging — IAA breach detected",
  },
  ...
  { ts: "4h ago", actor: "Workforce Agent", text: "Detected SME capacity gap in radiology domain" },
  {
    ...
    text: "Auto-drafted governance pack for tomorrow's call",
  },
...
export const dependencies = [
  {
    name: "Client schema v2 approval",
    type: "Client action",
    project: "Helios Docs",
    owner: "Helios IT",
    overdue: 4,
  ...
  {
    name: "Legal review of NDA addendum",
    type: "Internal",
    project: "Vertex Finance",
    owner: "Legal",
    overdue: 0,
  ...
  {
    name: "Reviewer training session",
    type: "Internal",
    project: "Falcon Voice",
    owner: "L&D",
    overdue: 1,
    status: "In Progress",
  },
...
export const escalations = [
  {
    title: "IAA drift on radiology subset",
    project: "Pulse Medical",
    severity: "Critical",
    raisedBy: "Quality Agent",
    date: "Jun 18",
    status: "Open",
    assigned: "Maya Chen",
    notes: "Calibration round scheduled for Jun 22.",
  },
  {
    title: "Schema sign-off delay",
    project: "Helios Docs",
    severity: "High",
    raisedBy: "Arben K.",
    date: "Jun 17",
    status: "In Progress",
    assigned: "Client PM",
    notes: "Awaiting Helios IT response.",
  },
  {
    title: "Capacity shortfall NLP",
    project: "Nimbus NLP",
    severity: "High",
    raisedBy: "Workforce Agent",
    date: "Jun 16",
    status: "Open",
    assigned: "Priya R.",
    notes: "Considering 4-SME re-allocation.",
  },
  {
    title: "Reviewer turnover Voice",
    project: "Falcon Voice",
    severity: "Medium",
    raisedBy: "Sara L.",
    date: "Jun 15",
